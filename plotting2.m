...
recurdyn = load('analysis_result.txt');

figure
set(gcf,'Color',[1,1,1])
subplot(2,2,1)
plot(recurdyn(:,1), recurdyn(:,2),'LineWidth',1.5)
hold on
...
subplot(2,2,2)
plot(recurdyn(:,1), recurdyn(:,3),'LineWidth',1.5)
hold on
...
subplot(2,2,3)
plot(recurdyn(:,1), recurdyn(:,4),'LineWidth',1.5)
hold on
...
subplot(2,2,4)
plot(recurdyn(:,1), recurdyn(:,5),'LineWidth',1.5)
hold on
